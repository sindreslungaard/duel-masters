    ...
    <div className="group/button relative">
      <button
        ...
        className={`w-full px-4 py-2 ${
          variant === "outline" ? "" : "bg-gradient-to-r text-white"
        } text-xs font-medium rounded-md shadow-lg transition-all duration-200 whitespace-nowrap overflow-hidden text-ellipsis ${getColorClasses()}`}
      >
        {children}
      </button>

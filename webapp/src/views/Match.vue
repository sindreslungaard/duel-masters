<template>
  ...
  >
    ...
    <div v-if="previewCard" class="card-preview">
      <img :src="`https://scans.shobu.io/${previewCard.uid}`" />
    ...
    <div v-if="previewCards" class="cards-preview" @click="dismissLarge()">
      ...
      <img
        ...
        :key="index"
        :src="`https://scans.shobu.io/${card.uid}`"
      />
      <br /><br />
      ...
      <div class="stage opponent">
        <div class="manazone">
          <div class="card mana placeholder">
            <img src="https://scans.shobu.io/backside" />
          </div>
          <div
            @contextmenu.prevent="showLarge(card)"
          ...
          >
            <img :src="`https://scans.shobu.io/${card.uid}`" />
          </div>
        </div>
        ...
        <div class="right-stage-content">
          ...
          <div class="card">
            <img
              ...
              src="https://scans.shobu.io/backside.png"
            />
            <img
              @contextmenu.prevent="
              ...
              style="height: 10vh"
              :src="`https://scans.shobu.io/${state.opponent.graveyard[0].uid}`"
            />
          </div>
          ...
          <div class="card">
            <img
              @contextmenu.prevent=""
              style="height: 10vh"
              src="https://scans.shobu.io/backside"
            />
          </div>
        </div>
      </div>
        ...
        <div class="right-stage-content">
          ...
          <div class="card">
            ...
            <img
              ...
              style="height: 10vh"
              :src="`https://scans.shobu.io/${state.me.graveyard[0].uid}`"
            />
          </div>
